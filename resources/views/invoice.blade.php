                ...
                <div class="col-md-12">
                    <div id="invoice" class="effect2 m-t-10">
                        ...
                        <div id="invoice-bot">
                                ...
                                <div class="table-responsive">
                                    <table class="table" style="width: 99%!important;">
                                        ...
                                        <tr class="tabletitle">
                                            ...
                                            <td class="tableitem">
                                                <h6 style="margin-right: 10px;">{{ $data['currency_data']->symbol }} {{ $data['price']}}</h6>
                                            </td>
                                        </tr>
                                        @if($data['discount']>0)
                                        <tr class="service1">
                                            ...
                                            <td class="tableitem">
                                                <h6 style="margin-right: 10px;">{{ $data['currency_data']->symbol }} {{ $data['discount_amount']}}</h6>
                                            </td>
                                        </tr>
                                        @endif
                                        @if($data['gst_per']>0)
                                        ...
                                        <tr class="service1">
                                            ...
                                            <td class="tableitem">
                                                <h6 style="margin-right: 10px;">{{ $data['currency_data']->symbol }} {{ $data['gst_amount']}}</h6>
                                            </td>
                                        </tr>
                                        @elseif($data['vat']==1)
                                        <tr class="service1">
                                        ...
                                        <tr class="service1">
                                            ...
                                            <td class="tableitem">
                                                <h6 style="margin-right: 10px;">{{ $data['currency_data']->symbol }} {{ $data['gst_amount']/2}}</h6>
                                            </td>
                                        </tr>
                                        <tr class="service1">
                                            <td class="tableitem"></td>
                                        ...
                                        <tr class="tabletitle">
                                            ...
                                            <td class="tableitem">
                                                <h6 style="margin-right: 10px;">{{ $data['currency_data']->symbol }} {{ $data['total_amount'] }}</h6>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            @php
                            if($data['quotation']->bank_id && $data['quotation']->bank)
                            {
                            @endphp
                            <div id="legalcopy">
                                <p class="legal"><strong><b>Payment Details are as mentioned below :</b></strong></p>
                                ...
                                <div class="legal1">
                                    ...
                                    echo $data['quotation']->bank->bank_detail;
