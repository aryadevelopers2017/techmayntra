                        ...
                        <div id="invoice" class="effect2 m-t-10">
                            ...
                            <div class="row">
                                <div class="col-md-6" style="text-align: left;">
                                    <h2 style="font-size:14px !important;"><strong>{{ $data['company_data']->company_name }}</strong></h2>
                                ...
                                <div class="col-md-3" style="text-align: left;">
                                    <h2 style="font-size:14px !important;"><strong>To, {{ $data['customer_company_name'] }}</strong></h2>
                                        ...
                                        <table class="table" style="width: 99%!important;">
                                            ...
                                            @foreach($data['item_data'] as $item )
                                                <tr class="service1">
                                                    ...
                                                    <td class="tableitem">
                                                        <p class="itemtext">{{ $currency_data->symbol }} {{ $item->rate }} </p>
                                                    </td>
                                                    <td class="tableitem">
                                                        <p class="itemtext">{{ $item->qty }} {{ $item->qty_name }}</p>
                                                    </td>
                                                    <td class="tableitem">
                                                        <p class="itemtext" style="margin-right: 10px;">{{ $currency_data->symbol }} {{ $item->price }}</p>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            <tr class="tabletitle">
                                                ...
                                                <td class="tableitem"><h6 style="margin-right: 10px;">{{ $currency_data->symbol }} {{ $data['price']}}</h6></td>
                                            </tr>
                                            @if($data['discount']>0)
                                                <tr class="service1">
                                                    <td class="tableitem"></td>
                                                    ...
                                                    <td class="tableitem"><h6 style="margin-right: 10px;">{{ $currency_data->symbol }} {{ $data['discount_amount']}}</h6></td>
                                                </tr>
                                            @endif
                                            @if($data['gst_per']>0)
                                                @if($data['igst']==1)
