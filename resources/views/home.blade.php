                        ...
                        <div class="card">
                            <div class="stat-widget-two">
                                <div class="stat-content">
                                    <div class="stat-text">Total Approved Amount </div>
                                    <div class="stat-digit"><i class="fa fa-inr"></i>{{ $data['approved_amount'] }}</div>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-success w-80" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div> -->
